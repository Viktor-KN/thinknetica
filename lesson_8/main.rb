...
main_menu = {
  '1' => { title: 'Stations...', action: :show_menu,
           params: %i[stations_menu] },
  '2' => { title: 'Trains...', action: :show_menu,
           params: %i[trains_menu] },
  '3' => { title: 'Wagons...', action: :show_menu,
           params: %i[wagons_menu] },
  '4' => { title: 'Routes...', action: :show_menu,
           params: %i[routes_menu] },
  '9' => { title: 'Load seed data', action: :load_seed,
           params: %i[] },
  '0' => { title: 'Exit', action: :quit,
           params: %i[] }
}
...
routes_menu = {
  ...
  '4' => { title: 'Remove station from route...',
           action: :remove_station_from_route, params: %i[routes] }
}
